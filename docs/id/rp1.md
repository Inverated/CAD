...
<div style="display: flex; align-items: center; gap: 2em; margin-bottom: 2em; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 500px; max-width: 700px;">
    ...
    <p style="font-size: 0.9em; color: #666; margin-top: 0.5em; font-style: italic;">Roti Proa I, dinahkodai oleh Penasihat Solar Proa Abdullah Farid, melakukan uji performa pada 30 Mei 2025</p>
  </div>
</div>
...
- **Kapasitas surya:** 1 kW puncak (2 panel)
- **Propulsi:** Motor tempel listrik 2 kW
- **Baterai:** 2 x 50 Ah, LiFePO₄
- **Rig layar:** Dua rig sport independen (Optimist) untuk konfigurasi eksperimental
