...
Usage:
    ...
    python -m src.physics cog --design artifact/boat.design.FCStd \
                              --materials constant/material/proa.json \
                              --output artifact/boat.cog.json

    # Compute center of buoyancy at a specific pose
    python -m src.physics cob --design artifact/boat.design.FCStd \
...
from src.physics.center_of_mass import compute_center_of_gravity, compute_cog_from_mass_artifact
